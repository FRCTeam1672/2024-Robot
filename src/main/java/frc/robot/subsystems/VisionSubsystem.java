...
public class VisionSubsystem extends SubsystemBase {
  ...
  private final Transform3d robotToCam = new Transform3d(new Translation3d(0.778, 0.285, 0.4), new Rotation3d(0,Math.toRadians(20),Math.toRadians(3))); //Cam mounted facing forward, half a meter forward of center, half a meter up from center.
