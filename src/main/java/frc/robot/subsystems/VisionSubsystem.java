...
public class VisionSubsystem extends SubsystemBase {
  ...
  private final Transform3d robotToCam = new Transform3d(new Translation3d(0.5, 0.0, 0.5), new Rotation3d(0,0,Math.toRadians(0))); //Cam mounted facing forward, half a meter forward of center, half a meter up from center.
